 ...
 * Note : this tag can be used to repeat only one row (in Word and in Excel this works like normal loop tag and repeats
 * the cells defined by the rectangular boundary of starting and closing tag).
 */
public class InlineDataLoop extends Loop{
     ...
     */
    public InlineDataLoop(String name, RenderElement[] elements) {
        super(name, elements);
    }
