...
public class LineSeries extends XYSeries {
    ...
    /**
     * @return Whether the corners of the angels formed in the data-points are smoothened.
     */
    ...
    /**
     * @return Symbol representing the datapoints. Can be square, diamond or triangle.
     */
    ...
    /**
     * @return Size of the symbol representing the data-points in (in em, pt, px, cm or in), by default: automatic.
     */
    ...
    /**
     * @return Thickness of the connecting line in em, pt, px, cm or in. e.g. : 20 pt.
     */
    ...
    /**
     * @return Style of the line. Supported options can be found online on the AOP documentation.
     */
