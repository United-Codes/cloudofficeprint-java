...
/**
 * Only supported in Word templates, might work in other templates but behaviour
 * is not predictable. When substituting the content in a language written in
 * right to left, like Arabic, this class can be used to properly format the
