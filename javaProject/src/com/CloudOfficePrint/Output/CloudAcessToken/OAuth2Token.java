...
/**
 * Class to use for OAuth 2 tokens. To store output on Dropbox, Google Drive or
 * OneDrive.
 */
public class OAuth2Token extends CloudAccessToken {
    ...
    /**
     * Constructor for an OAuth2Token object. Needs to be used if output wants to be
     * stored on Dropbox, Google Drive or OneDrive.
     * 
