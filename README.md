...
- solar system example: SolarSystemDocx.java & SolarSystemPptx.java
- SpaceX example: SpaceXExample.java (the most extensive example)

The examples can be found in the directory 'src/com/CloudOfficePrint/Examples' of the project on [Github](https://github.com/United-Codes/apexofficeprint-java). Some examples have a markdown file with explanation if needed.
