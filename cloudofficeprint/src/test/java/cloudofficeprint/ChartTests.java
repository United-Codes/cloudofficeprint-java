...
public class ChartTests {
	...
	public void testChartOptions() {
		...
		options.setFirstSliceAngle(45);
		options.setHoleSize(50);
		options.setEnableAreaTransparency(true);
