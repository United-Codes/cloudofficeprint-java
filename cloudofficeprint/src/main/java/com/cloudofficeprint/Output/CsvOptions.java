...
public class CsvOptions {
	...
	/**
	 * @return The character set. Should be an integer. See:
	...
	/**
	 * @param characterSet The character set. Should be an integer. See:
	 *                     https://wiki.openoffice.org/wiki/Documentation/DevGuide/Spreadsheets/Filter_Options#Filter_Options_for_Lotus.2C_dBase_and_DIF_Filters
	 *                     for possible values. Default 0 or system encoding.
	 */
	...
	/**
	 * Constructor for the CsvOptions object. Set the options with the setters.
