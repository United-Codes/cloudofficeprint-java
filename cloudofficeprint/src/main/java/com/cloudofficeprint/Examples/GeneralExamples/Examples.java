...
public class Examples {
    ...
    public void localTemplate(String APIKey) {
        try {
            ...
            Output output = new Output("pdf", "raw", null, null, null, null, pdfOptions, null);
    ...
    public void loopExample(String APIKey) {
        try {
            ...
            Output output = new Output("pdf", "raw", null, null, null, null, null, null);
            Base64Resource base64Resource = new Base64Resource();
    ...
    public void prependAppendSubTemplatesExample(String APIKey) throws Exception {
        ...
        Output output = new Output("pdf", "raw", "libreoffice", null, null, null, null, null);
