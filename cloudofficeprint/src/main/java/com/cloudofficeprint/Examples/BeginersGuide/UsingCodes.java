...
public class UsingCodes {
    public void main() throws Exception {
        System.out.println("I am in codes example");

        // Load template
        Base64Resource template = new Base64Resource();
        InputStream resourceAsStream = getClass().getResourceAsStream("/BeginnerGuide/UsingCodes/template.docx");
        ...
        //QR code
        QRCode qrCode = new QRCode("qrcode_name", "qr code ", "https://www.cloudofficeprint.com/");
