...
public class Base64Resource extends Resource {
    ...
    /**
     * Constructor for creating an uninitialised object of this class. Needs to be
     * populated with setFileFromLocalFile.
     */
    ...
    public void setFileFromLocalFile(String filePath) throws Exception {
        ...
        // Tika tika = new Tika();
        // setMimeType(tika.detect(file)); // would be a better way to do it but it
        // throws two warnings.
