...
public class TableOfContents extends RenderElement {
    ...
    /**
     * @return How the space between title and page number should be filled. Can be
     *         "hyphen", "underscore", or "dot" (default).
     */
    ...
    /**
     * @param tabLeader How the space between title and page number should be
     *                  filled. Can be "hyphen", "underscore", or "dot" (default).
     */
     ...
     * @param tabLeader How the space between title and page number should be
     *                  filled. Can be "hyphen", "underscore", or "dot". (Optional,
     *                  default : "dot")
     */
