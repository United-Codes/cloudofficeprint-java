...
/**
 * Represents series for stacked column charts where the y-axis is expressed in
 * percentage.
 */
public class ColumnStackedPercentSeries extends XYSeries {

    /**
     * This object represents series for a stacked column chart where the y-axis is
