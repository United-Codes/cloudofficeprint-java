...
public class D3Code extends Property {
    ...
    /**
     * @return Global data the code has access to. You can access it in the JS code
     *         through with global.data or just data.
     */
    ...
    /**
     * @param data Global data the code has access to. You can access it in the JS
     *             code through with global.data or just data.
     */
